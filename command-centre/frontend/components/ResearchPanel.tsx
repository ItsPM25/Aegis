...
export default function ResearchPanel() {
  ...
  if (error) {
    return <div className="p-8 text-center text-sm text-zinc-500">{error}</div>;
  }
  if (!data) {
    return <div className="p-8 text-center text-sm text-zinc-500">Loading research results…</div>;
  }

  return (
    <div className="gsap-panel h-full overflow-y-auto bg-zinc-950/95 p-6 scroll-thin">
      <div className="mb-6">
